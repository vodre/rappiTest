...
public class FragmentMoviesBindingImpl extends FragmentMoviesBinding  {
    ...
    public FragmentMoviesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentMoviesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.moviesSwipeRefreshLayout.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
